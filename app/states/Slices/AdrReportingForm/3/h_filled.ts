...
import { FormStateType, ActionType, ActionType1, FormStateTypeAdditional } from "~/types/reducers/adrReporting/3/h_filled";

const initialState: FormStateType = {
    drugDetails: []
}

export const form1page3hFilledSlice = createSlice({
    name: "form1page3hFilled",
    initialState,
    reducers: {
...
export const { setAdditionalFormData, editAdditionalFormData, removeAdditionalFormData } = form1page3hFilledSlice.actions;

export default form1page3hFilledSlice.reducer