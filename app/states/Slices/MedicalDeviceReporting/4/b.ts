...
export const form3page4bSlice = createSlice({
    name: 'form3page4b',
    initialState,
    reducers: {
...
export const { fetchIncompleteFormsFromUserProfile, submitFormDataToTheBackend, setNewFormData } = form3page4bSlice.actions

export default form3page4bSlice.reducer;
