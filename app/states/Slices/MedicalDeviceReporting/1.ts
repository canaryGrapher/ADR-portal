...
export const form3page1Slice = createSlice({
    name: 'form3page1',
    initialState,
    reducers: {
...
export const { fetchIncompleteFormsFromUserProfile, submitFormDataToTheBackend, setNewFormData } = form3page1Slice.actions

export default form3page1Slice.reducer