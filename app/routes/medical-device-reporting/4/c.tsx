...
import {
  setNewFormData,
  getFormData,
} from "~/states/Slices/MedicalDeviceReporting/4/c";
...
export default function Form2page4c() {
  const info = () => {
  ...
  const formState = useSelector((state: RootState) => state.form2page4c);
  useEffect(() => {
