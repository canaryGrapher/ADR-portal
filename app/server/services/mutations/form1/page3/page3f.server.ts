...
const addToForm = async (user: string, formID: string, formInput: any) => {
    try {
        ...
        if (form1Pointer) {
            ...
            if (!form1Pointer.form1Page3.Form1Page3f) {
                // creating empty object if Page3a does not exist
                form1Pointer.form1Page3.Form1Page3f = {}
            }
            form1Pointer.form1Page3.Form1Page3f = { ...formInput, isComplete: true }
            form1Pointer.save()
                .then(() => {
            ...
            return "Form 1 Page 3f modified successfully"
        } else {
...
const getForm = async (user: string, formID: string) => {
    try {
        ...
        if (form1Pointer) {
            return form1Pointer.form1Page3?.Form1Page3f
        } else {
            return "Form 1 Page 3f does not exist"
        }
    }
    catch (error) {
    }
