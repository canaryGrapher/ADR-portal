...
const addToForm = async (user: string, formID: string, formInput: any) => {
    try {
        ...
        if (form1Pointer) {
            ...
            if (!form1Pointer.form1Page3.Form1Page3e) {
                // creating empty object if Page3a does not exist
                form1Pointer.form1Page3.Form1Page3e = {}
            }
            form1Pointer.form1Page3.Form1Page3e = { ...formInput, isComplete: true }
            form1Pointer.save()
                .then(() => {
            ...
            return "Form 1 Page 3e modified successfully"
        } else {
...
const getForm = async (user: string, formID: string) => {
    try {
        ...
        if (form1Pointer) {
            return form1Pointer.form1Page3?.Form1Page3e
        } else {
            return "Form 1 Page 3e does not exist"
        }
    }
    catch (error) {
    }
